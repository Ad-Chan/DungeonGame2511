...
public abstract class DungeonLoader {
	...
	private void loadEntity(Dungeon dungeon, JSONObject json) {
        ...
        case "exit":
        	...
        	break;
        case "switch":
        	FloorSwitch floorSwitch = new FloorSwitch(x, y, uniqueID, "FloorSwitch");
        	onLoad(floorSwitch);
        	entity = floorSwitch;
        	uniqueID++;
        	break;
        case "boulder":
        	...
        	break;
        case "sword":
        	Sword sword = new Sword(x, y, uniqueID, "Sword");
        	onLoad(sword);
        	entity = sword;
        	uniqueID++;
        	break;
        case "invincibility":
        	InvincibilityPotion potion = new InvincibilityPotion(x, y, uniqueID, 10, "InvincibilityPotion");
        	onLoad(potion);
        	entity = potion;
        	uniqueID++;
        	break;
        case "treasure":
        	Treasure treasure = new Treasure(x, y, uniqueID, "Treasure");
        	onLoad(treasure);
        	entity = treasure;
        	uniqueID++;
        	break;
        case "key":
        	Key key = new Key(x, y, uniqueID , 4, "Key");
        	onLoad(key);
        	entity = key;
        	uniqueID++;
        	break;
        case "door":
        	Door door = new Door(x, y, 4, "Door");
        	onLoad(door);
        	entity = door;
        	break;
        case "enemy":
        	Enemy enemy = new Enemy(x, y, uniqueID, "Enemy");
        	onLoad(enemy);
        	entity = enemy;
        	uniqueID++;
        	break;
        case "bomb":
        	UnlitBomb bomb = new UnlitBomb(x, y, uniqueID, "UnlitBomb");
        	onLoad(bomb);
        	entity = bomb;
        	uniqueID++;
        	break;
